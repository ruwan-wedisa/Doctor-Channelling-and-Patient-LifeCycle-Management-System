...
if(isset($_POST['delete'])){
    ...
    $query = "DELETE FROM heightweightage order by did desc limit 1";
...
<div class="w3-container w3-padding" >
			<br><br><br><br>
			<div class="w3-container w3-padding " >
				<h1 align="left"><strong>height</strong></h1>
                <div class="row">
            ...
            <div class="w3-container w3-padding">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <h2 style="font-size:72px;">180</h2>
                        m</span>
                    </div>
...
<script>
    ...
    var totalVal1 = parseInt("<?php echo $arrHeight[0]; ?>");
    var totalVal2 = parseInt("<?php echo $arrHeight[1]; ?>");
    var totalVal3 = parseInt("<?php echo $arrHeight[2]; ?>");
    var totalVal4 = parseInt("<?php echo $arrHeight[3]; ?>");
    var totalVal5 = parseInt("<?php echo $arrHeight[4]; ?>");
