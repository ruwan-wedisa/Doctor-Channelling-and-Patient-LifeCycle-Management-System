...
<div class="w3-top ">
  <div class="w3-bar w3-red w3-card w3-padding ">
    ...
    <a href="contact.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">CONTACT</a>
      ...
      <div class="w3-dropdown-hover w3-hide-small">
          <button class="w3-padding-large w3-button" title="More">MANAGE RECEPTIONIST <i class="fa fa-caret-down"></i></button>
      <div class="w3-dropdown-content w3-bar-block w3-card-4">

          <a href="addReceptionist.php" class="w3-bar-item w3-button">Add Receptionist</a>
          <a href="viewReceptionist.php" class="w3-bar-item w3-button">Edit Receptionist</a>
      ...
      <div class="w3-dropdown-hover w3-hide-small">
          ...
          <div class="w3-dropdown-content w3-bar-block w3-card-4">
              ...
              <a href="LatestNews.php" class="w3-bar-item w3-button">Update News</a>
