...
<div class="modal fade" id="myModal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" target="_top">
                    ...
                    <input type="hidden" name="return" value="http://localhost/channelling/admin/paymentComplete.php?approved=true&timeslot=<?php echo $timeSlotNum?>&dayBooked=<?php echo $dayBooked?>
  &Date=<?php echo $appoinmentDate?>
                    ...
                    ">
                    <input type="hidden" name="cancel_return" value="http://localhost/channelling/admin/paymentComplete.php?approved=false&timeslot=<?php echo $timeSlotNum?>&dayBooked=<?php echo $dayBooked?>">
