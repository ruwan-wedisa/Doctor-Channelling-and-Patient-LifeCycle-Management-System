...
$sql = "SELECT DISTINCT * FROM rbsugar WHERE id= '".$uid."' ORDER BY RBSid DESC  LIMIT 5  ";
...
if(isset($_POST['delete'])){
    ...
    $query = "DELETE FROM rbsugar order by RBSid desc limit 1";
            ...
            <div class="w3-container w3-padding">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        GLUCOSE/Random(mg/dL)</span>
                    </div>
					<div class="col-lg-4 w3-padding">
                        <br>
                        <h4><strong><?php echo $afterBefore[0]?></strong></h4>
                    </div>
