...
<div class="w3-top ">
  <div class="w3-bar w3-red w3-card w3-padding ">
    ...
    <a href="search_Doc.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">DOCTORS</a>
      ...
      <a href="todayBookings.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">TODAY BOOKINGS</a>
      <a href="chenneling.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">OTHER CHANNELING</a>
