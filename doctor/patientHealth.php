...
$sql = "SELECT * FROM heightweightage WHERE id= '".$patientID."' ";
...
$sql2 = "SELECT * FROM otherdetail WHERE id='".$patientID."'";
...
#For Cholostrol
$sql3 = "SELECT * FROM cholostrol WHERE id= '".$patientID."' ";
...
#For FBSugar
$sql4 = "SELECT * FROM fbsugar WHERE id= '".$patientID."' ";
...
#For RBSugar
$sql5 = "SELECT * FROM rbsugar WHERE id= '".$patientID."' ";
...
#For Blood Pressure
$sql6 = "SELECT * FROM bpressure WHERE id= '".$patientID."' ";
...
if(isset($_POST['submit1'])){
    ...
    $q1="INSERT INTO `cholostrol` ( `id`, `date`, `total`, `HDL`, `LDL`, `VLDL`, `TRI`) VALUES ( '".$patientID."', '".$date1."', '".$total1."', '".$HDL1."', '".$LDL1."', '".$VLDL1."', '".$tri1."')";
...
if(isset($_POST['submit2'])){
    ...
    $q2="INSERT INTO `fbsugar` ( `id`, `date`, `glucose`) VALUES ( '".$patientID."', '".$date2."', '".$glucose1."')";
...
if(isset($_POST['submit3'])){
    ...
    $q3="INSERT INTO `rbsugar` ( `id`, `date`, `glucose`, `afterBefore`) VALUES ( '".$patientID."', '".$date2."', '".$glucose1."','".$afterBefore2."')";
...
if(isset($_POST['submit4'])){
    ...
    $q4="INSERT INTO `bpressure` ( `id`, `date`, `systolic`, `diasolic`) VALUES ( '".$patientID."', '".$date3."', '".$syst."','".$dias."')";
...
if(isset($_POST['submit5'])){
    ...
    $q5="INSERT INTO `heightweightage` ( `id`, `date`, `height`, `weight`, `Age`) VALUES ( '".$patientID."', '".$date5."', '".$height1."','".$weight1."','".$age1."')";
...
if(isset($_POST['submit9'])){
    ...
    $q6="INSERT INTO `allergy`(`id`, `type`, `reaction`, `date`, `still_have`) VALUES ('".$patientID."','".$allergenType."','".$reaction."','".$date8."','".$existingAllergen."')";
            ...
            <div class="panel panel-primary">
                <div class="container">
                    <table class="table" >
                        ...
                        $sql7 = "SELECT * FROM uploadedprescriptions WHERE uid='".$patientID."' ";
...
$sql8 = "SELECT * FROM allergy WHERE id='".$patientID."'";
