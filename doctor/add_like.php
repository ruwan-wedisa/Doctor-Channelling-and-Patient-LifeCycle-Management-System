        ...
        <table class="table table-striped" align='center' width='70%'>
            ...
            if(mysqli_num_rows($query)){
                while($row = mysqli_fetch_assoc($query)){
                    ...
                    <thead><th style="color:#0f0f0f;background:rgba(25,20,0,0.2);"><b><?php echo $msg?> <nbsp;> <?php echo $row['userName']?></b> </th>
                    <th style="color:#0f0f0f;background:rgba(25,20,0,0.2);"></th></thead>
                    <tr><td style="align:center;"><p class="text-info "><b>Comment:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<?php echo $row['comment']?><b></p></td>
                        <td>
                            ...
                            $id = $row['comment_id'];
                            ?>
                            <button type="button" class='btn btn-success delete' id='del_<?php echo $id; ?>'>Reply</button>
                        </td></tr>
                    <tr><td style="color:grey;"><p style="font-size: 18px"><b>Reply:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $row['reply']?> </b></p> </td>
