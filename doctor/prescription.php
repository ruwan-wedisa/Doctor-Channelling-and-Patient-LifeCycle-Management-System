...
// if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
            $sql = "INSERT into prescription(pid,date, link) VALUES ('$submit_id','" . $date . "', '" . $imageName . "')";
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-lg-8">
                    <form method="post" action="prescription.php?id=2" enctype="multipart/form-data"	 id="AddDoctorForm" class="needs-validation">
